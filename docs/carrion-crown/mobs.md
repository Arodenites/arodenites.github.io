...
## Mouring Maiden
<img src="assets/3Uk2AqKvR/mouring_maiden.png" width="500" align="left" style="margin-right: 15px; margin-bottom: 10px;">
...
# Oozes
Bir peltemsi; şekilsiz veya değişken yapıda, genellikle zekası olmayan bir yaratıktır.

## Grey Ooze

<img src="assets/3Uk2AqKvR/gray_ooze.jpg" width="500" align="left" style="margin-right: 15px; margin-bottom: 10px;">

Sıradan görünen bir su birikintisi, nemli bir taş parçası veya parıldayan bir kaya; korkunç bir yalancı ayağın (pseudopod) dışarı fırlamasıyla birdenbire gerçek kimliğini açığa çıkarır.

- SQ: Şeffaf
- Özel Saldırılar: Asit, sıkıştırma (constrict)
...
# Outsiders
Bir outsider, en azından kısmen Materyal Düzlem dışındaki başka bir düzlemin özünden (materyalinden olması şart değildir) oluşur. Bazı yaratıklar hayata başka bir tür olarak başlar ve daha yüksek (veya daha düşük) bir ruhani varlık aşamasına ulaştıklarında outsidera dönüşürler.
...
# Plants
Bu tür, bitkisel yaratıkları kapsar. Bahçelerde ve tarlalarda yetişen sıradan bitkilerin Bilgelik (Wisdom) ve Karizma (Charisma) skorlarının olmadığını; canlı olmalarına rağmen yaratık değil, nesne sayıldıklarını unutmayın.

## Fiendish Leshy
<img src="assets/3Uk2AqKvR/fiendish_leshy.jpg" width="500" align="left" style="margin-right: 15px; margin-bottom: 10px;">

Aslında daha güçlü peri soyları (fey) ve zeki bitki yaşamı için hizmetkarlar olarak yetiştirilen leşiler; zeki olmayan kardeşlerine göz kulak olan ve doğanın yeşil gözcüleri olarak hizmet veren duyarlı bitkilerdir.

Leşiler grup olarak belirli ortak özellikleri paylaşırlar. Bitkilere benzerler ancak belli belirsiz insansı (humanoid) görünümleri vardır ve Küçük (Small) boyuttadırlar. Aynı türün leşileri aynı genel şekli paylaşsa da, leşiler görünüş olarak bitki dünyasının tüm çeşitliliğine sahiptir.

Şeytani Leşiler, yozlaşma, nekromansi veya kötü rünler nedeniyle ortaya çıkan kötücül leşilerdir.

Özel Saldırılar: Smite Good, Channel Energy

Küçük oldukları için ormanlık alanlarda onları tespit etmek ve öldürmek oldukça zordur.

---

# Undead 
Undeadler; ruhani veya doğaüstü güçler tarafından canlandırılmış, bir zamanlar yaşayan canlılardır.

## Burning Skeletons
<img src="assets/3Uk2AqKvR/burning_skeleton.png" width="500" align="left" style="margin-right: 15px; margin-bottom: 10px;">

Kemik yığını aniden hareketlenir, insansı bir form almak üzere ayağa kalkar ve kızıl-turuncu alevler saçarak parlar. Uzun, kemikli parmakları, hiç sönmeyen bir ateşle yanarak yaşayanları tırmalamak için uzanır.

Yanan bir iskelete bitişik olan yaratıklar, turlarının başında ateş hasarı alırlar.

- SQ: Yakıcı Ölüm (fiery death)

- Zayıflık: Soğuk

- Bağışıklık: Ateş

- Yakın Dövüş: Pençe artı ateş veya 2 pençe artı ateş

- DR: Ezici (bludgeoning)

Yanan bir iskelet öldüğünde bir alev patlamasıyla infilak eder.

## Crawling Hands
<img src="assets/3Uk2AqKvR/crawling_hand.png" width="500" align="left" style="margin-right: 15px; margin-bottom: 10px;">

Sarsılarak canlanan bu kesik el, parmaklarını deforme olmuş bir örümcek gibi kullanarak büyük bir hızla ileri atılır.

## Ectoplasmic Human
<img src="assets/3Uk2AqKvR/ectoplasmic.png" width="500" align="left" style="margin-right: 15px; margin-bottom: 10px;">

Bu yapışkan ve değişken kütle insansı bir şekle sahiptir ancak bir tür yapışkan halat veya kumaştan yapılmış gibi görünür. Gövdesi, bu korkunç formunu korumaya çalışırcasına kesik kesik ve sarsılarak hareket eder.

- Sürekli: air walk

- SQ: Safha Sarsıntısı (yarı ruhani / phase lurch)

- Yakın Dövüş: Ezme (slam)

Ektoplazmik bir yaratık, duvarların veya madde engellerin içinden geçme yeteneğine sahiptir.

## Flaming Skull
<img src="assets/3Uk2AqKvR/flying_skull.png" width="500" align="left" style="margin-right: 15px; margin-bottom: 10px;">

İnsansı bu kafa, havada sessizce ve uğursuzca süzülürken yüzünden hala et parçaları sarkıyor ve havada sallandıkça grileşmiş dişleri hafifçe birbirine çarpıyor. Aynı zamanda alevler içinde.
...
## Poltergeist
<img src="assets/3Uk2AqKvR/poltergeist.png" width="500" align="left" style="margin-right: 15px; margin-bottom: 10px;">

Hayaletimsi, iskeletimsi bir figür, aletler, tabaklar, mutfak gereçleri ve diğer serbest eşyalardan oluşan dönen bir kasırganın ortasında yükselir.

- Özel Nitelikler (SQ): Bölgeye Bağlı (Site bound)
- Özel Saldırılar: Telekinezi
- Savunma Yetenekleri: Incorporeal, Doğal Görünmezlik

Poltergeist, herhangi bir nedenle öldüğü yeri terk edemeyen bir yaratığın ruhundan oluşan öfkeli bir ruhtur.

## Screaming Skulls
<img src="assets/3Uk2AqKvR/severed_head.png" width="500" align="left" style="margin-right: 15px; margin-bottom: 10px;">

Çaresizlik ve acıdan gelen ürpertici bir çığlık duvarlarda yankılanır; ardından köşenin ardından alevler içinde yanan, çeneleriyle havayı çiğneyen mavi (azure) kafataslarının yaydığı hafif bir parıltı belirir.

- Özel Saldırılar: Çığlık (Screaming)

Can puanları (HP) oldukça düşüktür ancak onlara ulaşamazsanız ciddi bir baş ağrısına dönüşebilirler.

## Skeletons
<img src="assets/3Uk2AqKvR/skeleton.png" width="500" align="left" style="margin-right: 15px; margin-bottom: 10px;">

Kemik yığını aniden hareketlenir ve insan şeklini alarak yükselir. Uzun kemik parmakları, yaşayanlara pençe darbeleri vurmak için uzanır.

- Yakın Dövüş: 2 Pençe (veya varsa elindeki silahı kullanır)
- Zayıflıklar: Bludgeoning silahlardan ekstra hasar alır.

İskeletler, lanetli büyü (foul magic) aracılığıyla yaşama döndürülmüş ölülerin canlandırılmış kemikleridir.
...
## Zombies
<img src="assets/3Uk2AqKvR/zombie.png" width="500" align="left" style="margin-right: 15px; margin-bottom: 10px;">

Üzerinde sadece birkaç kirli paçavra olan bu yürüyen ceset, kollarını öne uzatmış bir halde sendeleyerek ilerliyor, etleri kemiklerinden dökülüyor.

- Yakın Dövüş: Slam
- Zayıflıklar: Kesici (Slashing) silahlardan ekstra hasar alır.

Düşük seviyeli bir undead yaratıktır.
...
<img src="assets/3Uk2AqKvR/centipede.png" width="500" align="left" style="margin-right: 15px; margin-bottom: 10px;">

Halkalı vücuduyla kıvranıp duran bu tüyler ürpertici yaratık, avını ararken zehirli çenelerini kasıp gevşetiyor.

- Yakın Dövüş: Isırık (zehir)
- Özel Saldırılar: Zehir

## Giant Crab Spiders

<img src="assets/3Uk2AqKvR/spider.png" width="500" align="left" style="margin-right: 15px; margin-bottom: 10px;">

Soluk sarı renkli bu örümceğin bacakları iki yana doğru uzanarak ona oldukça belirgin bir duruş kazandırıyor. Yaratığın boyutu büyük bir köpek kadar.

Yakın Dövüş: Isırık (zehir)

Dev yengeç örümcekleri tehlikeli pusu avcılarıdır.
